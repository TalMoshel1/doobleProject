...
import Agriculture from "/Agriculture-Gallery-Background-Image.svg";
      ...
      <div className={styles.contentLayer}>
        <div className={styles.textContent}>
          ...
          <p className={styles.description}>
            התחרות "הגלריה החקלאית" של קנט נועדה לצבור הרחבה של התמונות הגדולות
            של החקלאות הישראלית. מטרתה לעודד תיעוד יצירתי ומקורי של עבודת האדמה,
            הטבע והנוף בישראל.
          </p>
